...
- ❌ Don't add an AI/assistant co-author signature or "generated by" trailer to
  commits, tags, CHANGELOG, or the audit log. This is a public repo — write in
  the project's own voice. The whole pass should land as one clean human-style
  commit + a tagged release others receive via *Check for updates*.
